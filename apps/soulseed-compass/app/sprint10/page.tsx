...
// the original / experience keeps working until the S89 cutover. Screens 3–9
// are filled in by S84+; for now they show a placeholder.
export default function Sprint10Page() {
  ...
  if (currentScreen === 2) return <Screen02Offer />;
